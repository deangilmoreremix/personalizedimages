...
const retroPrompts: RetroActionFigurePrompt[] = [
  ...
  },
  {
    ...
    basePrompt: "Create a vintage explorer-themed toy box containing a cartoon-style treasure hunter with bomber jacket, boots, and goggles. The figure stands with one foot on a treasure chest amid jungle ruin art with scattered coins. Inner card shows sketched maps, rope borders, and stamp badges; the box has a glossy comic-strip frame and a large clear window. Add a series logo splash, barcode, safety icons, and a faux price tag corner; studio lighting, clean reflections.",
  ...
  },
  {
    ...
    basePrompt: "Create a classic blister-carded ninja-mutant hero, crouched in attack pose with dual katanas, over a stylized city sewer tunnel backdrop with neon graffiti scribbles. The card features bright spray-paint shapes, a sewer manhole motif, and a bold series banner. Include accessory callout bubbles, a checklist backer, barcode, and safety icons. Photorealistic blister curvature, studio lighting, crisp edges.",
  ...
  },
  {
    ...
    basePrompt: "Create a foil-stamped window box for a feline jungle avenger with glowing blade, animal-inspired armor, and wild hair. The inner card shows a galactic storm sky; the package features metallic accents and midnight gradients. Add a collector crest, bio panel, and series icons. Product photography with controlled highlights on the window, deep shadows for drama, and crisp print details.",
  ...
  },
  {
    ...
    basePrompt: "Create a comic-styled gadget deluxe box featuring a trench-coat figure with extendable arms, springy hat, and a multi-tool backpack. Include a small loyal companion insert. The package has speech bubbles, a ‘Try Me’ flap icon, and playful blueprint line art. Add prop callouts, barcode, safety icons, and window reflections; bright studio lighting, crisp details.",
  ...
  },
  {
    ...
    basePrompt: "Create a matte-noir rooftop box for a caped duck crime-fighter with a gas gadget, posed in a heroic stance under a moonlit inner card. Include a spotlight-shaped window cut, gold-embossed crest, and villain poster insert. Add barcode, safety icons, and series numbering. Studio packshot with controlled highlights and crisp shadows.",
  ...
  },
  {
    ...
    basePrompt: "Create a recyclable eco-box for an elemental hero with wind, water, and fire effects swirling around. The package features cardboard earth motifs, eco badges, and plant-based inks. Include a globe cutout window, a cause badge, barcode, and safety icons. Photorealistic carton texture, soft lighting, and clean composition.",
  ...
  },
  {
    ...
    basePrompt: "Create a flip-open comic panel box for a superhuman with glowing hand effects, silver suit, and a tattered cape, posed before collapsing industrial wall art. Inside flap shows a power stat chart; the back shows cover-style graphics. Include accessory badges, barcode, and safety marks; photo-real window reflections, high detail.",
  ...
  },
  {
    ...
    basePrompt: "Create a 50s-diner themed box for a tall toon with dark shades and towering pompadour, captured mid-flex. Include vanity mirror card insert, chrome trims, and gym accessory tray. Photorealistic PET window, barcode, safety icons, and series stamp; studio lighting with clean reflections.",
  ...
  },
  {
    ...
    basePrompt: "Create a holographic science lab toy box for a kid genius with goggles, holding a test tube and remote. The front has a sliding-door motif and blueprint lines; include a gadget sound-FX pull tab icon. Add a mini lab table prop, barcode, safety icons; crisp reflections, macro-level detail.",
  ...
  },
  {
    ...
    basePrompt: "Create a water-tower-shaped tri-figure box containing three slapstick minis, with removable props (pie, mallet, microphone). The panel graphics show zany motion lines and a spin-mechanism pull-tab illustration. Include barcode, safety marks, and collector numbering. Bright, playful studio shot with crisp edges.",
  ...
  },
  {
    ...
    basePrompt: "Create a spiral-notebook themed box for a bright toon student with textbook and springy feet, posed mid-jump in a classroom backdrop. Include sketch margins, sticker sheet callouts, barcode, and safety icons. Photorealistic packaging with clean reflections and high detail.",
  ...
  },
  {
    ...
    basePrompt: "Create a transparent-grid tech box for a digital-era cyber hero with glowing armor and vector lines, standing on a base with binary rain and hovering cubes. Include an LED-effect sticker and code blade accessory. Barcode, safety icons, crisp window reflections, luminous accents; studio lighting.",
  ...
  },
  {
    ...
    basePrompt: "Create an art-deco stone-textured rooftop display box for a nocturnal caped vigilante with a grappling tool. The inner card shows a moody skyline with a spotlight cutout. Include accessory badges, barcode, and safety marks. Photorealistic materials, controlled highlights, crisp print.",
  ...
  },
  {
    ...
    basePrompt: "Create a star-pink heart-window box for a magical heroine with crescent wand and flowing ribbons, staged on a transparent glitter stand over a moonlight base. Include a spell quote ribbon, barcode, and safety icons. Soft sparkling lighting, delicate reflections, high detail.",
  ...
  },
  {
    ...
    basePrompt: "Create a tri-color curved-front cityscape box for three chibi flying heroines with heart-trail effects. Include pop-out sticker tabs, monster insert, and a mayor phone prop. Add barcode and safety marks; bright toy photography, glossy window, crisp detail.",
  ...
  },
  {
    ...
    basePrompt: "Create a cracked gothic box for a winged gargoyle perched on a cathedral ledge at sunset. Include folded-wings swap parts and a glowing-eyes variant. Inner card shows stained glass and stone textures; add 'Nightfall Unleashed' sticker, barcode, and safety icons. Moody studio lighting, crisp materials.",
  ...
  },
  {
    ...
    basePrompt: "Create a pineapple-inspired window package for a cheerful sea-sponge figure with bubble wand and jellyfish net, set on a coral reef base with goofy alternate faces. Add transparent water-splash window element, barcode, and safety icons. Bright studio lighting, crisp edges, high detail.",
  ...
  },
  {
    ...
    basePrompt: "Create a spiral sketchpad flip box for a thoughtful suburban teen with backpack and sketchbook, posed under a tree backdrop. Include journal sticker, doodle margins, barcode, and safety icons. Soft studio lighting, gentle shadow, crisp packaging.",
  ...
  },
  {
    ...
    basePrompt: "Create a grass-texture blister card with mud-splatter effects for a toddler adventurer holding a toy compass and juice bottle, posed in a backyard jungle display. Include plant base, sticker sheet callouts, barcode, and safety icons. Photoreal blister, macro details, bright lighting.",
  ...
  },
  {
    ...
    basePrompt: "Create a swirl-pattern cutout box for a frantic wallaby holding a grocery bag spilling surreal items, with a quirky vacuum and wavy sidewalk base insert. Add zig-zag energy borders, barcode, and safety marks. Clean reflections, cartoonish yet photoreal packaging.",
  ...
  {
    archetype: "Scam Pack",
    basePrompt: "Create a crayon-drawn cardboard-fort tri-figure box for three oddball schemers with jawbreakers, blueprints, and slapstick tools. Include duct-tape printed trims, a cart of schemes, and a catapult insert. Add barcode, safety icons; studio lighting with crisp window and playful textures.",
