...
**SECURITY NOTE**: The `.env` file is intentionally excluded from the Git repository for security reasons. It contains your actual API keys which should never be committed to version control.
...
- **Google Gemini**: Get your API key at [ai.google.dev](https://ai.google.dev)
- **Giphy**: Get your API key at [developers.giphy.com](https://developers.giphy.com)
- **Stripe**: Get your keys at [dashboard.stripe.com](https://dashboard.stripe.com)
